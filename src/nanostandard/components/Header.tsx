...
export function Header({ navigation, className }: HeaderProps) {
  return (
    <header
      class={`container mx-auto px-4 py-6 flex justify-between items-center ${className}`}
    >
        ...
        <nav>
          <ul className="flex space-x-10 text-gray-600 items-center">
            ...
            <li class="relative group">
              <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md transition-colors flex items-center gap-1 shadow-sm">
                Dashboards
                <svg
                  class="w-4 h-4"
                  viewBox="0 0 24 24"
